...
func (e *executableSchema) Complexity(typeName, field string, childComplexity int, rawArgs map[string]interface{}) (int, bool) {
	...
	case "Query.calculatePrice":
		if e.complexity.Query.CalculatePrice == nil {
			break
		}

		args, err := ec.field_Query_calculatePrice_args(context.TODO(), rawArgs)
		if err != nil {
			return 0, false
		}
...
func (ec *executionContext) _Query_calculatePrice(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	defer func() {
		if r := recover(); r != nil {
	...
	args, err := ec.field_Query_calculatePrice_args(ctx, rawArgs)
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	}
	...
	resTmp, err := ec.ResolverMiddleware(ctx, func(rctx context.Context) (interface{}, error) {
		...
		return ec.resolvers.Query().CalculatePrice(rctx, args["type"].(models.TradeType), args["margin"].(float64), args["exchangeRate"].(float64))
	})
	if err != nil {
		ec.Error(ctx, err)
		return graphql.Null
	...
	for i, field := range fields {
		...
		case "calculatePrice":
			...
			out.Concurrently(i, func() (res graphql.Marshaler) {
				...
				res = ec._Query_calculatePrice(ctx, field)
				if res == graphql.Null {
...
func (ec *executionContext) unmarshalNtradeType2githubᚗcomᚋvictorᚑnachᚋpriceᚑcalculatorᚋmodelsᚐTradeType(ctx context.Context, v interface{}) (models.TradeType, error) {
	var res models.TradeType
	err := res.UnmarshalGQL(v)
	return res, graphql.ErrorOnPath(ctx, err)
}

func (ec *executionContext) marshalNtradeType2githubᚗcomᚋvictorᚑnachᚋpriceᚑcalculatorᚋmodelsᚐTradeType(ctx context.Context, sel ast.SelectionSet, v models.TradeType) graphql.Marshaler {
	return v
}
